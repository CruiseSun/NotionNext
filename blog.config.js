...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'fukasawa-pro', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  GREETING_WORDS:
    ...
    'Hello，我是一名算法程序员,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '巡游阳光', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '热爱技术，热爱生活', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cruisesun.tech', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '推荐, 算法, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'joe_hua@126.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/CruiseSun', // 你的github个人主页 例如 https://github.com/tangly1024

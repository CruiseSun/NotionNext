...
const InfoCard = (props) => {
  ...
  return <div id='info-card' className='py-0'>
    <div className='text-lg justify-left dark:text-gray-300'>博主：</div>
    <div className='items-center justify-center'>
        ...
        <div className='flex-col flex justify-center'>
            <div className='text-lg py-2 hover:scale-105 transform duration-200 flex justify-center dark:text-gray-300'>{siteConfig('AUTHOR')}</div>

...
function AsideLeft(props) {
  ...
  return <div className={`sideLeft relative ${isCollapsed ? 'w-0' : 'w-40'} duration-300 transition-all bg-white dark:bg-hexo-black-gray min-h-screen hidden lg:block z-20`}>
        {/* 折叠按钮 */}
